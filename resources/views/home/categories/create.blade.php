                ...
                @csrf
                    <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <img class="rounded-circle avatar-image" alt="" src="{{ asset('assets/img/s2.png') }}" style="heigh:130px ; width:130px">
                            ...
                            <div class="form-group">
                                ...
                                avatar-input border-form-control @error('image') is-invalid @enderror"
                                name="image" value="{{ old('image') ? old('image') : auth()->user()->image }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name"  placeholder="Insira o nome da categoria" type="text"
                                 class="form-control border-form-control @error('name') is-invalid @enderror"
                                 name="name" value="{{ old('name') ? old('name') : ''}}" required autocomplete="name">
